...
MLU_0000 = select(data02, subj_id, visit)

MLU_01 = filter(data02, CHI_MLU > 2.7)

#Figuring out whcih children had a MLU under 1.5 in the first visit.
...
MW_6 = arrange(data02, data02$tokens_CHI> data02$visit == 6)
