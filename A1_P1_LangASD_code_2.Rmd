...
#This function will, using a pipe, arrange the new dataframe from the lowest to the highest amount of words uttered in the 6th visit.  The answer is subject number 55.

#mw_06 = group_by(data02, visit == 6) %>% arrange(tokens_CHI)

if data02$visit == 6 {
  arrange(data02$tokens_CHI)
}
...
ASD_01 = subset(data02, Diagnosis = "ASD", CHI_MLU, tokens_CHI)
data01 = subset(final_df, select = -c(ADOS, MullenRaw, ExpressiveLangRaw))
