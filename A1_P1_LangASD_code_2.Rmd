...
MLU_03 = group_by(data02, subj_id) %>%
  summarize(data02, n(data02$visit))
...
SEL_001 = select(data02, contains(Diagnosis =="ASD"), CHI_MLU, tokens_CHI)

ASD_01= subset(select(data02, Diagnosis = "ASD", CHI_MLU, tokens_CHI))
